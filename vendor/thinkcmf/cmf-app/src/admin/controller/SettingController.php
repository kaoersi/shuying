...
class SettingController extends AdminBaseController
{
    ...
    public function companyabout()
    {
       ...
       $this->assign('company_info', cmf_get_option('company_info'));
        return $this->fetch();
    }
     /**
     * 公司简介提交
     */
     public function companyaboutPost()
    {

        if ($this->request->isPost()) {
            

            $company_info = $this->request->param('options/a');
            cmf_set_option('company_info', $company_info);
            $this->success("保存成功！", '');
...
$rankset=cmf_get_option('rankset');
       ...
       $this->assign('rankset',$rankset);
        return $this->fetch();
    }
      /**
     * 公司简介提交
     */
     public function rannksetPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $post ['rankname_titles']=$this->request->param('rankname_titles');
            $post ['rankname_en']=$this->request->param('rankname_en');
            $post ['rankname_descs']=$this->request->param('rankname_descs');
            cmf_set_option('rankset', $post);
            $this->success("保存成功！", '');
 ...
 /**
    ...
    public function teacher()
    {
       ...
       $this->assign('company_info', cmf_get_option('teacher'));
        return $this->fetch();
    }
     /**
     * 名师团队提交
     ...
     public function teacherPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $teacher_info = $this->request->param('options/a');
            cmf_set_option('teacher', $teacher_info);
            $this->success("保存成功！", '');
