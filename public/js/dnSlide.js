  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            //S 新增标题以及描述
            this.resourceSrc_titArr = this.container.find('img').map(function(i,e){return e.title;});
            this.resourceSrc_descArr = this.container.find('img').map(function(i,e){return e.alt;});
            //E
            ...
            jQuery.each(this.resourceSrcArr , function(i,e){
                 // S 新增标题以及描述
                ulDOM.append('<li class="dnSlide-item"><a href="javascript:void(0)"><img class="slide-img" src="'+_this_.resourceSrcArr[i]+'" width="100%"><p class="cus_label cus_label_tit">'+_this_.resourceSrc_titArr[i]+'</p><p class="cus_label cus_label_des">'+_this_.resourceSrc_descArr[i]+'</p></a></li>');
            });
        ...
        countSettingValue : function(){
           ...
           var firstimgheight=this.dnSlideFirstItem.find(".slide-img").height();
           if(firstimgheight < 1){
            if($(window).width() > 768){
               firstimgheight='383';
            }else{
