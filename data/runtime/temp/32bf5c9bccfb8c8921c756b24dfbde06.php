<?php /*a:9:{s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/show_schooldetail.html";i:1636620293;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer_tabinfo.html";i:1635820161;s:75:"/www/wwwroot/www.shuyingjp.com/themes/default/public/right_relation_wd.html";i:1637722427;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/right_hotlabel.html";i:1635752604;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer_yxk.html";i:1635761470;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		<meta charset="UTF-8">
		<title><?php echo (isset($article['title']) && ($article['title'] !== '')?$article['title']:''); ?>留学_本科|研究生申请条件_排名_费用_辅导机构_<?php if(empty($site_info['site_seo_title']) || (($site_info['site_seo_title'] instanceof \think\Collection || $site_info['site_seo_title'] instanceof \think\Paginator ) && $site_info['site_seo_title']->isEmpty())): ?><?php echo (isset($site_info['site_name']) && ($site_info['site_name'] !== '')?$site_info['site_name']:''); else: ?><?php echo (isset($site_info['site_seo_title']) && ($site_info['site_seo_title'] !== '')?$site_info['site_seo_title']:''); ?><?php endif; ?></title>
        ...
        <div class="ban-con-yxk">
			<div class="ban-show-yxk-l fl">
				<a rel="nofollow" href="" class="ban-show-yxk-l-img fl" title="">
					<span><img src="<?php echo get_img_url($article['slogo']); ?>" alt=""></span>
				</a>
				<div class="ban-show-yxk-l-r fr">
					<div>
						<em><?php echo $article['rw_title']; ?></em>
						<h4><?php echo $article['title']; ?></h4>				
						<p>地理位置：<?php echo $article['address']; ?> </p>
						<p>学校类别：综合类</p>
						<div class="school_link">
							<!--<a rel="nofollow" href="<?php echo $article['weburl']; ?>" target="_blank" class="a_s_link hover" title="点击查看官网">点击查看官网</a>-->
							<a rel="nofollow" href="<?php echo (isset($site_info['online_url']) && ($site_info['online_url'] !== '')?$site_info['online_url']:''); ?>" target="_blank" class="a_s_link" title="点击咨询我们">点击咨询我们</a>
						</div>
					</div>
				</div>
			</div>
			<div class="ban-show-yxk-r fr">
				<div>
					<span>第 <strong><?php echo $article['rank_qs']; ?></strong> 位</span>
					<p>QS世界大学排名</p>
				</div>
			</div>
		</div>
    ...
    <div class="yxk-show-l">
        ...
        <div class="yxk-show-article  yxk-show-article-tab hover clearfix">
            <div class="yxk-article_left">
                <p><img src="<?php echo get_img_url($article['slogo']); ?>" alt="<?php echo $article['title']; ?>"></p>
                <?php echo htmlspecialchars_decode($article['content']) ?>
            </div>
            <img src="<?php echo get_img_url($article['more']['thumbnail']); ?>" class="yxk_articleshow_img" alt="<?php echo $article['title']; ?>">
        </div>
        <div class="yxk-show-article yxk-show-article-tab clearfix">
        <div class="yxk-article_left" style="padding-right: 0px;">
        <?php echo htmlspecialchars_decode($article['yaoqiu']) ?>
    </div>
</div>
...
<div class="yxk-show-article yxk-show-articlenew  yxk-show-article-tab clearfix">
    <div class="school_news_list">
        <?php 
         ...
         if(is_array($relation_list_zixun) || $relation_list_zixun instanceof \think\Collection || $relation_list_zixun instanceof \think\Paginator): if( count($relation_list_zixun)==0 ) : echo "" ;else: foreach($relation_list_zixun as $key=>$vo): $more1=json_decode($vo['more'],true); ?>
            <dl> 
                <dt><a href="javascript:void(0);" target="_self" class="scale-img" title=""><img src="<?php echo get_img_url($more1['thumbnail']); ?>" alt="<?php echo $vo['title']; ?>"></a></dt> 
                <dd> 
                    <h3 class="ellipsis"><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></h3> 
                    <div class="tit_addon">
                        <span class="time"><?php echo date('Y-m-d',$vo['create_time']); ?></span><span class="tags">
                            <?php 
                             ...
                             if(is_array($keywords_arr) || $keywords_arr instanceof \think\Collection || $keywords_arr instanceof \think\Paginator): if( count($keywords_arr)==0 ) : echo "" ;else: foreach($keywords_arr as $key=>$vk): $taginfo= Db::name('CmsTags')->where("type = 1")->where('name','=',$vk)->order('nums desc')->find(); ?>
                                <a href="javascript:void(0);" title=""><?php echo $vk; ?></a>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                         </span>
                    </div> 
                    <p><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title=""><?php echo mb_substr($vo['description'],0,80,'utf-8'); ?>...</a></p> 
                </dd> 
            </dl>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
...
<div class="footer">
    <div class="wrapper">
        ...
        <?php 
            ...
            $model_cur=$request_index->module();
            $action_cur=$request_index->controller();
         if($houzui[0] == 'jpschool' || $houzui[0] == 'jlschool' && $isnum && $title != ''): ?>
			<div class="link_tit">友情链接</div>
            <div class="link_con">
            	<?php 
					$catname = Db::name('Link_category')->where('catname','=',$title)->select()->toArray();
                    if($catname){
                        $catid = $catname[0][id];
                        $linklist3= Db::name('Link')->where('type='.$catid.' and status=1')->select();
                    }
					
                 if($linklist3): if(is_array($linklist3) || $linklist3 instanceof \think\Collection || $linklist3 instanceof \think\Paginator): if( count($linklist3)==0 ) : echo "" ;else: foreach($linklist3 as $key=>$k1): ?>
