<?php /*a:12:{s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_lxsq_sgu.html";i:1635504173;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/banner.html";i:1627535148;s:69:"/www/wwwroot/www.shuyingjp.com/themes/default/public/jiaoxuetixi.html";i:1635499128;s:70:"/www/wwwroot/www.shuyingjp.com/themes/default/public/teacher_list.html";i:1635497704;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/case_list.html";i:1635498560;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/news_list.html";i:1635755136;s:65:"/www/wwwroot/www.shuyingjp.com/themes/default/public/qa_list.html";i:1635498054;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
$image='';
 ...
 ?>
<div class="school_tit school_tit_apply">申请SGU<span> / 申し込み</span></div>
<div class="apply_con apply_con_sgu">
<p><?php echo str_replace('|','</p><p>',$post['applycon']); ?></p>
</div>
</div>
</div>
<div class="section_feature bgf2f3f5">
<div class="wrapper">
<div class="school_tit school_tit_feature">SGU特点<span>  / SGUの特徴  </span></div>
<ul class="feature_con feature_con_sgu clearfix">
<?php 
if(!empty($post['apply_td'])){
 ...
 if(is_array($apply_td) || $apply_td instanceof \think\Collection || $apply_td instanceof \think\Paginator): if( count($apply_td)==0 ) : echo "" ;else: foreach($apply_td as $k=>$vo): ?>
<li>
<div class="feature_txt">
<i></i><img src="/public/images/sgu_feature_img<?php echo $k+1; ?>.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p>
</div>
<div class="feature_txt_hover">
<i></i><img src="/public/images/sgu_feature_img<?php echo $k+1; ?>_h.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
...
if(!empty($post['apply_base'])){
 ...
 if(is_array($apply_base) || $apply_base instanceof \think\Collection || $apply_base instanceof \think\Paginator): if( count($apply_base)==0 ) : echo "" ;else: foreach($apply_base as $k=>$vo): ?>
<li>
<img src="<?php echo get_img_url($vo['url']); ?>" alt="<?php echo $vo['title']; ?>">
<div class="base_txt"><?php echo $vo['title']; ?></div>
<div class="base_txt_hover">
<span><?php echo $vo['title']; ?></span>
<label><p><?php echo str_replace('|','</p><p>',$vo['desc']); ?></p></label>
</div>
</li>
...
<div class="wrapper">
<div class="school_tit school_tit_system">4VS1塾樱教学体系<span>/ 每一个重要节点，给你安排最专业的老师</span></div>
<ul class="section_list_system clearfix">
  <?php 
    $slide_list9= Db::name('SlideItem')->where(array('slide_id'=>'9'))->order('list_order asc,id desc')->select();
 if(is_array($slide_list9) || $slide_list9 instanceof \think\Collection || $slide_list9 instanceof \think\Paginator): if( count($slide_list9)==0 ) : echo "" ;else: foreach($slide_list9 as $key=>$vo): ?>
  <li><div class="sys_box"><i></i><em><?php if($key < 9): ?>0<?php endif; ?><?php echo $key+1; ?></em><span><?php echo $vo['title']; ?></span></div></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
<a rel="nofollow" class="yjs_consult_btn trs"  title="点击咨询我们" href="<?php echo (isset($site_info['online_url']) && ($site_info['online_url'] !== '')?$site_info['online_url']:''); ?>" target="_blank">点击咨询我们 ></a>
</div>
</div>
