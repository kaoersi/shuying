<?php /*a:8:{s:65:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_mxalk.html";i:1635142004;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:76:"/www/wwwroot/www.shuyingjp.com/themes/default/public/banner_search_item.html";i:1634730291;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/ranklist.html";i:1635141781;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
	   <head>
        <meta charset="UTF-8">
...
<div class="starcase_nav">
 <?php
$cms_sub_categories_data = \app\cms\service\ApiService::subCategories(6);
 if(is_array($cms_sub_categories_data) || $cms_sub_categories_data instanceof \think\Collection || $cms_sub_categories_data instanceof \think\Paginator): $k = 0; $__LIST__ = $cms_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($key < 2): ?>
<a href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['name']; ?>" <?php if($category['id'] == $vo['id']): ?> class='hover' <?php endif; ?>><?php echo $vo['name']; ?></a>
<?php endif; ?>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
</div>
...
<dt><img src="<?php echo get_img_url($vo['slogo2']); ?>" alt="<?php echo $vo['title']; ?>"></dt>
<dd>
<strong><?php echo $vo['title']; ?></strong>
<p><span><?php echo $arr_xz[$vo['xingzhi']]; ?></span>&nbsp;&nbsp;<span><?php echo $arr_location[$vo['yuyanxx']]; ?></span><!-- <span><?php echo $vo['address']; ?></span> --></p>
</dd>
</a>
</dl>
<?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="starcse_right">
<img src="/public/images/star_school_bg.png" alt="大学排名">
<strong>大学排名</strong>
<ul class="star_pm ">
<?php 
  $rankset = cmf_get_option('rankset');
 if(is_array($rankset[rankname_titles]) || $rankset[rankname_titles] instanceof \think\Collection || $rankset[rankname_titles] instanceof \think\Paginator): if( count($rankset[rankname_titles])==0 ) : echo "" ;else: foreach($rankset[rankname_titles] as $k=>$vo): ?>
<li><em><?php echo $rankset[rankname_en][$k]; ?></em><a href="<?php echo $rankset[rankname_descs][$k]; ?>" title="<?php echo $vo; ?>"><?php echo $vo; ?></a></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
</div>
...
<div class="starcase_nav">
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>1)); ?>" class="hover" title="本科">本科</a>
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>2)); ?>" title="研究生">研究生</a>
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>3)); ?>" title="大学院 ">大学院 </a>
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>4)); ?>" title="语言学校">语言学校 </a>
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>5)); ?>" title="JLPT">JLPT</a>
</div>
</div>
 ...
 if(is_array($case_fenxi) || $case_fenxi instanceof \think\Collection || $case_fenxi instanceof \think\Paginator): if( count($case_fenxi)==0 ) : echo "" ;else: foreach($case_fenxi as $key=>$vo): ?>
    <div class="analyse-slide">
        <div class="progress-msg">
            <a href="<?php echo cmf_url('cms/Abroad/index',array('id'=>$vo['id'])); ?>" title=""> <img src="<?php echo get_img_url($vo['litpic']); ?>" class="self-pic" alt="<?php echo $vo['title']; ?>"></a>
        ...
        <div class="progress-msg-hover">
            ...
            <a href="<?php echo cmf_url('cms/Abroad/index',array('id'=>$vo['id'])); ?>" class="more" title="点击查看">点击查看 ></a>
        </div>
    </div>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<a href="<?php echo cmf_url('cms/Abroad/listnew',array('id'=>1)); ?>" class="more_case" title="查看更多">查看更多</a>
</div>
</div>
...
<div class="swiper-container swiper-container-taste">
    <div class="swiper-wrapper">
        <?php if(is_array($slide_list17) || $slide_list17 instanceof \think\Collection || $slide_list17 instanceof \think\Paginator): if( count($slide_list17)==0 ) : echo "" ;else: foreach($slide_list17 as $k=>$vo): ?>
            <div class="swiper-slide clearfix">
                <div class="taste_item">
                    <h4 style="font-size: 18px;font-weight: normal;text-align: center;margin-bottom: 15px;"><?php echo $vo['title']; ?><?php echo $vo['content']; ?></h4>
                    <img src="<?php echo get_img_url($vo['image']); ?>" alt="<?php echo $vo['title']; ?>" style="width: 100%;height: auto;">
                </div>
            </div>
         <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
...
<?php if(is_array($slide_list17) || $slide_list17 instanceof \think\Collection || $slide_list17 instanceof \think\Paginator): if( count($slide_list17)==0 ) : echo "" ;else: foreach($slide_list17 as $k=>$vo): ?>
    <img src="<?php echo get_img_url($vo['image']); ?>" alt="<?php echo $vo['content']; ?>" title="<?php echo $vo['title']; ?>">
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<?php endif; ?>
</div>
...
<li class="video-list-li">
    <div class="vedio_box"><i class="btn_on"  data-id="react-video<?php echo $vo['id']; ?>" vpath="<?php echo get_img_url($more['thumbnail']); ?>" ipath="<?php echo get_img_url($vo['vediourl']); ?>"></i><img src="<?php echo get_img_url($more['thumbnail']); ?>" class="vedio_bg imgvediobz" alt="<?php echo $vo['title']; ?>"> </div>
