...
<div class="feature_txt">
       <i></i><img src="/public/images/yjs_feature_img<?php echo $k+1; ?>.png" alt="研究生特点"><strong><?php echo $vo['title']; ?></strong><p><?php echo str_replace('|','<s></s>',$vo['desc']); ?></p></div>
<div class="feature_txt_hover">
       <i></i><img src="/public/images/yjs_feature_img<?php echo $k+1; ?>_h.png" alt="研究生特点"><strong><?php echo $vo['title']; ?></strong><p><?php echo str_replace('|','<s></s>',$vo['desc']); ?></p>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
...
<li>
<img src="<?php echo get_img_url($vo['url']); ?>" alt="<?php echo $vo['title']; ?>"><div class="base_txt"><?php echo $vo['title']; ?></div>
<div class="base_txt_hover">
<span><?php echo $vo['title']; ?></span>
<label><p><?php echo str_replace('|','</p><p>',$vo['desc']); ?></p></label></div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
