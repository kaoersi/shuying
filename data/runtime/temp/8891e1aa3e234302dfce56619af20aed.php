<?php /*a:8:{s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_zuixin.html";i:1638352571;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer_tabinfo.html";i:1635820161;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/right_hotlabel.html";i:1635752604;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <?php 
    ...
    <meta charset="UTF-8">
    <title>
        <?php if(empty($category['more']['seotitle']) || (($category['more']['seotitle'] instanceof \think\Collection || $category['more']['seotitle'] instanceof \think\Paginator ) && $category['more']['seotitle']->isEmpty())): ?>
            <?php echo $category['name']; else: ?>
                <?php echo $category['more']['seotitle']; ?>
        <?php endif; ?>
            _
        <?php if(empty($site_info['site_seo_title']) || (($site_info['site_seo_title'] instanceof \think\Collection || $site_info['site_seo_title'] instanceof \think\Paginator ) && $site_info['site_seo_title']->isEmpty())): ?>
            <?php echo (isset($site_info['site_name']) && ($site_info['site_name'] !== '')?$site_info['site_name']:''); else: ?>
            <?php echo (isset($site_info['site_seo_title']) && ($site_info['site_seo_title'] !== '')?$site_info['site_seo_title']:''); ?>
        <?php endif; ?>
    </title>
    ...
    <div class="school_news_list school_case_list"> 
     ...
     $more=json_decode($vo['more'],true);
      ?>
        <dl> 
            <dt>
                <a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" class="scale-img"><img src="<?php echo get_img_url($more['thumbnail']); ?>"></a>
            </dt> 
            <dd> 
                <h3 class="ellipsis"><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title=""><?php echo $vo['title']; ?></a></h3> 
                <div class="tit_addon">
                <span class="time"><?php echo date('Y-m-d H:i:s',$vo['published_time']); ?></span>
             ...
             <p><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title=""><?php echo mb_substr($vo['description'],0,70,'utf-8'); ?>...</a></p> 
            </dd> 
            <a class="plus">+</a>
       </dl>
    <?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <div class="Hot_aside Hot_Ask">
                ...
                <ul class="hot_list clearfix">
                   <?php 
                     ...
                     if(is_array($relation_list_wd) || $relation_list_wd instanceof \think\Collection || $relation_list_wd instanceof \think\Paginator): if( count($relation_list_wd)==0 ) : echo "" ;else: foreach($relation_list_wd as $k=>$vo): ?>
                        <li>
                            <a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
