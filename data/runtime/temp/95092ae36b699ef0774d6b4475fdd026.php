<?php /*a:6:{s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_dxpm_qs.html";i:1637724285;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
							...
							<div class="swiper-slide text-center">
								<a href="<?php echo $vo['url']; ?>" title="">
									<div class="m-list-bg m-list-bg1" style="position: relative;width: 302px;height: 224px;">
										<img src="<?php echo get_img_url($vo[image]); ?>" alt="" style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;">
			...
			<div class="m-img" id="m-list-swiper" style="position: relative;padding: 0 30px;">
				<div class="swiper-container " id="m-ranking-list">
					<div class="swiper-wrapper">
						<?php 
							$slide_banner_list= Db::name('SlideItem')->where(array('slide_id'=>'24','status'=>'1'))->order('list_order asc,id desc')->select();
						 if(is_array($slide_banner_list) || $slide_banner_list instanceof \think\Collection || $slide_banner_list instanceof \think\Paginator): if( count($slide_banner_list)==0 ) : echo "" ;else: foreach($slide_banner_list as $k=>$vo): $more=json_decode($vo[more],true); ?>
							<div class="swiper-slide text-center">
								<a href="<?php echo $vo['url']; ?>" title="">
						...
						<li class="flex">
							<div class="tab-img">
								<?php if($vo['more']['thumbnail'] != ''): ?>
                                    <img src="<?php echo get_img_url($vo['more']['thumbnail']); ?>" alt="" class="pc-img list-img-pic">
                                <?php else: ?>
							...
							<div class="tab-content-right">
								...
								<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>">
									...
									<div class="flex items-center number">
										<div class="flex items-center time"><img src="/public/images/qs/time.png" alt=""><?php echo date('Y-m-d H:i:s',$vo['published_time']); ?></div>
										<div>
					...
					<div class="right-tab-con">
						<ul class="content-right-list">
							<?php 
								...
								$i = 1;
							 if(is_array($slide_list2) || $slide_list2 instanceof \think\Collection || $slide_list2 instanceof \think\Paginator): if( count($slide_list2)==0 ) : echo "" ;else: foreach($slide_list2 as $k=>$vo): ?>
								<li>
									<a href="/jpschool-<?php echo $vo['id']; ?>/" title="">
										<p class="red-right-yuandian"><?php echo $i; ?></p>
										<p><?php echo $vo['title']; ?></p>
										<p><?php echo $vo['rw_title']; ?></p>
									</a>
								</li>
								<?php 
									$i++;
						...
						<ul class="content-right-list hidden">
							<?php 
								...
								$i = 1;
							 if(is_array($slide_list3) || $slide_list3 instanceof \think\Collection || $slide_list3 instanceof \think\Paginator): if( count($slide_list3)==0 ) : echo "" ;else: foreach($slide_list3 as $k=>$vo): ?>
								<li>
									<a href="/jlschool-<?php echo $vo['id']; ?>/" title="">
										<p class="red-right-yuandian"><?php echo $i; ?></p>
										<p><?php echo $vo['title']; ?></p>
										<p><?php echo $vo['rw_title']; ?></p>
									</a>
