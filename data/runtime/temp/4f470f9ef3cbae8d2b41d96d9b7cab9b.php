<?php /*a:9:{s:63:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_tag.html";i:1637910393;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer_tabinfo.html";i:1635820161;s:75:"/www/wwwroot/www.shuyingjp.com/themes/default/public/right_zuixin_news.html";i:1637908928;s:72:"/www/wwwroot/www.shuyingjp.com/themes/default/public/right_hotlabel.html";i:1635752604;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    <?php 
...
<a style="color:#d5417b;"><?php echo $taginfo['name']; ?></a></p>
<a href="<?php echo cmf_url('cms/List/tag'); ?>" class="btn_all_tags" title="全部标签">全部标签&nbsp;&nbsp;></a></div>
...
$news_list=  Db::name('CmsArchives')->where('id','in',$ids)->where($whereArr)->order('create_time desc')->paginate(10);
 if(is_array($news_list) || $news_list instanceof \think\Collection || $news_list instanceof \think\Paginator): if( count($news_list)==0 ) : echo "" ;else: foreach($news_list as $key=>$vo): $more=json_decode($vo['more'],true); ?>
    <dl> 
    <dt><a class="scale-img" title="<?php echo $vo['title']; ?>"><img src="<?php echo get_img_url($more['thumbnail']); ?>" alt="<?php echo $vo['title']; ?>" ></a></dt> 
    <dd> 
    <h3 class="ellipsis"><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></a></h3> 
     ...
     <span class="tags">
        ...
        <a href="<?php echo cmf_url('cms/List/indextag',array('id'=>$taginfo['id'])); ?>" target="_blank" title="<?php echo $vk; ?>"><?php echo $vk; ?></a><?php endif; ?>
        <?php endforeach; endif; else: echo "" ;endif; ?><?php endif; ?></span></if>
     </div> <p><a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" target="_self" title="<?php echo $vo['title']; ?>"><?php echo mb_substr($vo['description'],0,70,'utf-8'); ?>...</a></p> </dd> 
    <a class="plus">+</a>
   </dl>
  <?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<div class="listpage clearfix">
            <?php echo $news_list->render(); ?> </div>
</div>
