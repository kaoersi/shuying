...
<div class="school_tit school_tit_apply">申请高中<span>/ 申し込み</span></div>
  <div class="apply_con"><?php echo $post['applycon']; ?> 
     </div></div></div>
...
<li><div class="feature_txt"><i></i>
                        <img src="/public/images/gz_feature_img<?php echo $k+1; ?>.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div>
                   <div class="feature_txt_hover"><i></i>
                        <img src="/public/images/gz_feature_img<?php echo $k+1; ?>_h.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div></li>
...
if(!empty($post['apply_base'])){
 ...
 if(is_array($apply_base) || $apply_base instanceof \think\Collection || $apply_base instanceof \think\Paginator): if( count($apply_base)==0 ) : echo "" ;else: foreach($apply_base as $k=>$vo): ?>
                <li>
                       ...
                       <div class="base_txt_hover"><span><?php echo $vo['title']; ?></span>
...
if(!empty($post['applyflow'])){
 ...
 if(is_array($applyflow) || $applyflow instanceof \think\Collection || $applyflow instanceof \think\Paginator): if( count($applyflow)==0 ) : echo "" ;else: foreach($applyflow as $k=>$vo): ?>
                        <li><strong>0<?php echo $k+1; ?></strong><i></i><a class="more"><?php echo $vo['title']; ?></a></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div></div>
