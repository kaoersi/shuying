<?php /*a:6:{s:65:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_vedio.html";i:1635407665;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
	   <head>
        <meta charset="UTF-8">
...
<div class="banner banner_about"></div>
<div class="section_star_vedio clearfix bgf2f3f5">
    <div class="wrapper">
        <div class="school_tit school_tit_starvedio">视频解析 <span>  / ビデオ解析</span></div>
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    ...
                    <li class="video-list-li">
                        <div class="vedio_box"><i class="btn_on"  data-id="react-video<?php echo $vo['id']; ?>" vpath="<?php echo get_img_url($vo['more']['thumbnail']); ?>" ipath="<?php echo get_img_url($vo['vediourl']); ?>"></i><img src="<?php echo get_img_url($vo['more']['thumbnail']); ?>" class="vedio_bg imgvediobz" alt="<?php echo $vo['title']; ?>">
                        </div>
