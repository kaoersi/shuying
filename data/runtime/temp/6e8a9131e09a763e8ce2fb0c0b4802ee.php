...
$image='';
 ...
 ?>
	        <style>
	        .apply_con{padding-top: 27px;}
	        .apply_con,.apply_con p{line-height: 35px;}
	        </style>
<div class="school_tit school_tit_apply wow"  data-wow-delay="0.1s">申请本科<span>/ 申し込み </span></div>
<div class="apply_con"><p><?php echo str_replace('|','</p><p>',$post['applycon']); ?></p>
</div></div></div>
<div class="section_feature bgf2f3f5">
<div class="wrapper">
<div class="school_tit school_tit_feature wow"  data-wow-delay="0.1s">本科特点<span>/ 学部の特徴  </span></div>
<ul class="feature_con feature_con_bk clearfix">
<?php 
...
<li>
<div class="feature_txt"><i></i><img src="/public/images/bk_feature_img<?php echo $k+1; ?>.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div>
<div class="feature_txt_hover"><i></i><img src="/public/images/bk_feature_img<?php echo $k+1; ?>_h.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div></li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
</div>
<div class="section_base">
<div class="wrapper">
<div class="school_tit school_tit_base wow"  data-wow-delay="0.1s">基本信息<span>/ 基本情報 </span></div>
<ul class="base_con">
<?php 
...
<label><p><?php echo str_replace('|','</p><p>',$vo['desc']); ?></p>
</label></div></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
</div>
<div class="section_tutor clearfix section_tutor_bk bgf2f3f5">
<div class="wrapper">
<div class="school_tit school_tit_tutor wow "  data-wow-delay="0.1s">一站式辅导平台<span>/ 塾樱陪你度过每一个重要阶段 </span></div>
<ul class="bk_tutor_con">
<?php 
 ...
 if(is_array($applyflow) || $applyflow instanceof \think\Collection || $applyflow instanceof \think\Paginator): if( count($applyflow)==0 ) : echo "" ;else: foreach($applyflow as $k=>$vo): ?>
<li><i></i><a class="more"><?php echo $vo['title']; ?></a></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
</div>
