<?php /*a:1:{s:78:"/www/wwwroot/www.shuyingjp.com/themes/admin_simpleboot3/admin/index/index.html";i:1627524480;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <?php $submenus=$menus; 
     ...
     if(!(empty($submenus) || (($submenus instanceof \think\Collection || $submenus instanceof \think\Paginator ) && $submenus->isEmpty()))):  $n=0; foreach($submenus as $menu){
				$n++;
		 ?>
		
        <li <?php if($n==1){echo "class='open'";}?>>
            ...
            <ul class="submenu" <?php if($n==1){echo "style='display:block'";}?>>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">蓝杉互动后台管理系统</a>
