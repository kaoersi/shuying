...
<li>
        <div class="feature_txt"><i></i><img src="/public/images/dxy_feature_img<?php echo $k+1; ?>.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div>
        <div class="feature_txt_hover"><i></i><img src="/public/images/dxy_feature_img<?php echo $k+1; ?>_h.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p></div></li>
...
<span><?php echo $vo['title']; ?></span><label><p><?php echo str_replace('|','</p><p>',$vo['desc']); ?></p></label>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
...
<div class="dxy_ys_left">
  <?php if(is_array($slide_list7) || $slide_list7 instanceof \think\Collection || $slide_list7 instanceof \think\Paginator): if( count($slide_list7)==0 ) : echo "" ;else: foreach($slide_list7 as $key=>$vo): ?>
<dl><dt>0<?php echo $key+1; ?></dt><dd><p><?php echo $vo['title']; ?></p><span><?php echo $vo['content']; ?></span></dd></dl>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
<div class="dxy_ys_right">
  <?php if(is_array($slide_list8) || $slide_list8 instanceof \think\Collection || $slide_list8 instanceof \think\Paginator): if( count($slide_list8)==0 ) : echo "" ;else: foreach($slide_list8 as $key=>$vo): ?>
<dl><dt>0<?php echo $key+1; ?></dt><dd><p><?php echo $vo['title']; ?></p><span><?php echo $vo['content']; ?></span></dd></dl>
<?php endforeach; endif; else: echo "" ;endif; ?>
</div>
</div>
