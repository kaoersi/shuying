<?php /*a:2:{s:85:"/www/wwwroot/www.shuyingjp.com/themes/admin_simpleboot3/cms/admin_archives/index.html";i:1627524525;s:74:"/www/wwwroot/www.shuyingjp.com/themes/admin_simpleboot3/public/header.html";i:1627524563;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('AdminArchives/index'); ?>">所有文章</a></li>
        <li><a href="<?php echo url('AdminArchives/add',array('cid'=>$category)); ?>">添加文章</a></li>
        <li><a href="<?php echo url('AdminArchives/recyclebin'); ?>">回收站</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('AdminArchives/index'); ?>">
        分类:
        ...
        <a class="btn btn-danger" href="<?php echo url('AdminArchives/index'); ?>">清空</a>
    </form>
        ...
        <div class="table-actions">
            <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
                <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                        data-action="<?php echo url('AdminArchives/listOrder'); ?>"><?php echo lang('SORT'); ?>
                </button>
            <?php endif; ?>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/publish',array('yes'=>1)); ?>" data-subcheck="true">发布
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/publish',array('no'=>1)); ?>" data-subcheck="true">取消发布
            </button>
            <!-- <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/top',array('yes'=>1)); ?>" data-subcheck="true">置顶
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/top',array('no'=>1)); ?>" data-subcheck="true">取消置顶
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/recommend',array('yes'=>1)); ?>" data-subcheck="true">推荐
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/recommend',array('no'=>1)); ?>" data-subcheck="true">取消推荐
            </button> -->
            <!--
            <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
            ...
            <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminArchives/delete'); ?>" data-subcheck="true" data-msg="您确定删除吗？">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): if( count($articles)==0 ) : echo "" ;else: foreach($articles as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
                            <a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>"
                               target="_blank"><?php echo $vo['title']; ?></a>
                            <?php else: ?>
                            <a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'])); ?>"
                               target="_blank"><?php echo $vo['title']; ?></a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <a class="label label-default"
                            href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['channel_id'])); ?>"
                            target="_blank"><?php echo $vo['b_name']; ?></a>
                    </td>
                    <td><?php echo $vo['user_nickname']; ?></td>
                    <td><?php echo (isset($vo['hits']) && ($vo['hits'] !== '')?$vo['hits']:0); ?></td>
                    <td>
                    ...
                    <td>
                        <?php if(!(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty()))): ?>
                            ...
                            <?php endif; if(!(empty($vo['keywords']) || (($vo['keywords'] instanceof \think\Collection || $vo['keywords'] instanceof \think\Paginator ) && $vo['keywords']->isEmpty()))): ?>
                    ...
                    <td>
                        <a class="btn btn-xs btn-primary" href="<?php echo url('AdminArchives/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                        <a class="btn btn-xs btn-danger js-ajax-delete"
                           href="<?php echo url('AdminArchives/delete',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
                    </td>
                </tr>
    ...
    $(function () {
        ...
        Wind.use('ajaxForm', 'artDialog', 'iframeTools', function () {
            ...
            $('.js-articles-copy').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/index.php?g=portal&m=AdminArchives&a=copy&ids=" + ids, {
                    title: "批量复制",
                    width: "300px"
                });
            });
            ...
            $('.js-articles-move').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/index.php?g=portal&m=AdminArchives&a=move&old_term_id=<?php echo (isset($term['term_id']) && ($term['term_id'] !== '')?$term['term_id']:0); ?>&ids=" + ids, {
                    title: "批量移动",
                    width: "300px"
                });
            });
