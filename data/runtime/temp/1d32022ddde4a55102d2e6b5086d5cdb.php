<?php /*a:4:{s:63:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/indexmob.html";i:1634643379;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;}*/ ?>
...
<?php endif; ?>
       ...
       <?php 
$slide_banner_list= Db::name('SlideItem')->where(array('slide_id'=>'1','status'=>'1'))->order('list_order asc,id desc')->select();
 ?>
    <div class="swiper-container swiper-container-banner">
				 <div class="swiper-wrapper">
				 	    <?php if(is_array($slide_banner_list) || $slide_banner_list instanceof \think\Collection || $slide_banner_list instanceof \think\Paginator): if( count($slide_banner_list)==0 ) : echo "" ;else: foreach($slide_banner_list as $k=>$vo): ?>
				  		<div class="swiper-slide"   data-swiper-autoplay="6000"><a href="<?php echo $vo['url']; ?>" title=""><img src="<?php echo get_img_url($vo['smallimage']); ?>" style="max-width:100%;"  class="indexbanimg<?php echo $k; ?>" alt=""></a></div>
			       	<?php endforeach; endif; else: echo "" ;endif; ?>
			       	</div>
		        <div class="swiper-pagination"></div>
	</div>
	</div>
	<div class="section-com-mob section-lxtj-mob clearfix wrapper">
	<h5 class="section_tit" ><label>留学途径</label><a href="/lxsqgz.html" class="more" title="留学途径">全部 &gt;</a></h5>
 <?php
$cms_sub_categories_data = \app\cms\service\ApiService::subCategories(1);
 if(is_array($cms_sub_categories_data) || $cms_sub_categories_data instanceof \think\Collection || $cms_sub_categories_data instanceof \think\Paginator): $k = 0; $__LIST__ = $cms_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
	...
	<dl>
	<dt> <a href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['id'])); ?>"><label><?php echo $vo['name']; ?></label></a></dt>
	<dd> <a href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['id'])); ?>">
	   <span><?php echo $vo['name']; ?></span>
		<p> 
		<?php 
       	  $des=str_replace('|','</p><p>',$vo['description']);
       	   ?><?php echo $des; ?></p>
       	  </a>
	</dd>
	</dl>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
<a href="javascript:void(0);" class="btn_show_more">查看更多</a>
   </div>
	<div class="section-com-mob section-lxtj-mob clearfix  bgf2f3f5">
	<div class="wrapper">
	<h5 class="section_tit section_tit_rypx" ><label>日语培训</label><a href="/cms/list/index/id/15.html" class="more" title="日语培训">全部 &gt;</a></h5>
...
$cms_sub_categories_data = \app\cms\service\ApiService::subCategories(2);
 if(is_array($cms_sub_categories_data) || $cms_sub_categories_data instanceof \think\Collection || $cms_sub_categories_data instanceof \think\Paginator): $k = 0; $__LIST__ = $cms_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
								...
								<li>
									<a href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['id'])); ?>" >
									<div class="rypx_top">
									...
									<div class="rypx_bot">
									  <p><?php echo $vo['name2']; ?></p>
										<span><?php 
       	                                $des2=str_replace('|','</span><span>',$vo['description']);
       	                                ?><?php echo $des2; ?></span>
										<div class="rypx_more"><label>查看更多</label></div>
									</div>
...
<div class="section-com section-tskc clearfix wrapper">
							<h5 class="section_tit section_tit_tskc"><label>特色课程</label><a href="/tskceju.html" class="more">全部 &gt;</a></h5>
<div class="swiper-container swiper-container-tskc">
    <div class="swiper-wrapper">
    <?php
$cms_sub_categories_data = \app\cms\service\ApiService::subCategories(3);
 if(is_array($cms_sub_categories_data) || $cms_sub_categories_data instanceof \think\Collection || $cms_sub_categories_data instanceof \think\Paginator): $k = 0; $__LIST__ = $cms_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
        ...
        <a href="<?php echo cmf_url('cms/List/index',array('id'=>$vo['id'])); ?>">
        	             <div class="tskc_txt tskc_txt<?php echo $k; ?>">
									<img src="/public/images/tskc_img<?php echo $k; ?>.png">
									<i></i>
									<strong><?php echo $vo['name']; ?></strong>
									</div>
	   </a>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="section-com-mob section-fwys-mob clearfix  bgf2f3f5">
	<div class="wrapper">
	<h5 class="section_tit section_tit_fwys" ><label>服务优势</label><a href="/" class="more">全部 &gt;</a></h5>
<dl class="fuyw_nav">
							<dd>一站式<s></s>服务</dd>
							<dd>留学<s></s>申请</dd>
							<dd>日语<s></s>培训</dd>
...
<div class="fwyw_con">
							...
							<dl>
							<div class="VS">VS</div>
							<dt><div class="btn_ys own"><label>塾樱</label></div><div class="btn_ys other"><label>传统机构</label></div></dt>
							<div class="show_btn_ys show_btn_ys1 hover">
							<dd>
								<p>6vs1，塾樱一站式教学团队</p>
								...
								<p>超过<strong>200人</strong>海外导师团队实现线上授课</p>
								<p>可匹配<strong>93.7%</strong>细分方向的导师</p>
							</dd>
                             </div>
                             <div class="show_btn_ys show_btn_ys2">
							<dd>
								<p>文书老师，仅负责翻译及申请</p>
								<p>需学员独自完成阅读并理解</p>
								<p>不提供任何专业知识辅导</p>
...
<div class="section-com-mob section-team clearfix">
						    <div class="wrapper">
							<h5 class="section_tit section_tit_team"><label>塾樱一站式教学团队</label></h5>
							<ul class="section_list_team clearfix">
								<li>
									<div class="team_txt">
									<i></i>
									<strong>留日规划顾问</strong>
									<p>
									<span>一对一个性化定制</span>
									<span>属于你的赴日蓝图</span>
									</p>
...
<div class="section-com-mob section-teacher clearfix">
						    <div class="wrapper">
							<h5 class="section_tit section_tit_teacher"><label>海外导师库</label><a href="/hwdsk.html" class="more">全部 ></a></h5>
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        ...
        <div class="swiper-slide">
        	<div class="teacher_txt">
									<img src="<?php echo get_img_url($vo['more']['thumbnail']); ?>">
									<div class="teach_info">
									<span><?php echo $vo['title']; ?></span>
									<?php 
									$str=explode("|",$vo['beijing']);
									 $str_bj=str_replace(',','</label><label>',$str[0]);
									 ?>
									<p><label><?php echo $str_bj; ?></label></p>
									</div>
...
<?php endforeach; endif; else: echo "" ;endif; ?>   
	...
	<?php 
   $news_bot_case= Db::name('CmsLxzk')->alias('a')->limit(1)->order('create_time desc')->select()->toArray();
  ?>
						<div class="news_item">
						<h5>名校案例库 <span>/ / オファー</span></h5>
						<div class="news_top">
						<a href="javascript:void(0);" class="top_img_a"><img src="/public/images/indexnews1.png"></a>
						...
						<a href="<?php echo cmf_url('cms/Abroad/index',array('id'=>$vo['id'])); ?>" class="more">查看更多>></a>
						<?php endif; ?>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
						</div>
<?php 
$whereArr['channel_id'] = array(24,37,38,40,56,57,58,59,61,62,41,49,52,53,54,55); // 其他条件
$whereArr['status'] = 1;
$whereArr['delete_time'] = 0;
  $news_top2= Db::name('CmsArchives')->alias('a')->join('ls_cms_appnews b','a.id = b.id')->
       where($whereArr)->order('create_time desc')->limit(1)->select()->toArray();
  ?>
						<div class="news_item">
						<h5>留学资讯 <span>/ お問い合わせ</span></h5>
<?php if(is_array($news_top2) || $news_top2 instanceof \think\Collection || $news_top2 instanceof \think\Paginator): if( count($news_top2)==0 ) : echo "" ;else: foreach($news_top2 as $k=>$vo): 
 $more=json_decode($vo['more'],true);
  ?>
						<div class="news_top">
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" class="top_img_a"><img src="<?php echo get_img_url($more['thumbnail']); ?>"></a>
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>"><p><?php echo $vo['title']; ?></p></a>
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>"><span><?php echo $vo['description']; ?></span></a>
						<a href="<?php echo cmf_url('cms/List/index',array('id'=>24)); ?>" class="more">查看更多>></a>
						</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
						<div class="news_item">
...
<?php 
$news_top= Db::name('CmsArchives')->alias('a')->join('ls_cms_appask b','a.id = b.id')->
       where(array('channel_id'=>'25'))->order('create_time desc')->limit(1)->select()->toArray();
  if(is_array($news_top) || $news_top instanceof \think\Collection || $news_top instanceof \think\Paginator): if( count($news_top)==0 ) : echo "" ;else: foreach($news_top as $k=>$vo): 
 $more=json_decode($vo['more'],true);
  ?>
						<div class="news_top">
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>" class="top_img_a"><img src="<?php echo get_img_url($more['thumbnail']); ?>"></a>
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>"><p><?php echo $vo['title']; ?></p></a>
						<a href="<?php echo cmf_url('cms/Archives/index',array('id'=>$vo['id'],'cid'=>$vo['channel_id'])); ?>"><span><?php echo $vo['description']; ?></span></a>
						<a href="<?php echo cmf_url('cms/List/index',array('id'=>25)); ?>" class="more">查看更多>></a>
						</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</div>
						</div>
