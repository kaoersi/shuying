<?php /*a:11:{s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/cms/list_syjh.html";i:1635408635;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/headertop.html";i:1635475802;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header.html";i:1638498801;s:68:"/www/wwwroot/www.shuyingjp.com/themes/default/public/header_mob.html";i:1635414385;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/banner.html";i:1627535148;s:70:"/www/wwwroot/www.shuyingjp.com/themes/default/public/teacher_list.html";i:1635497704;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/case_list.html";i:1635498560;s:67:"/www/wwwroot/www.shuyingjp.com/themes/default/public/news_list.html";i:1635755136;s:65:"/www/wwwroot/www.shuyingjp.com/themes/default/public/qa_list.html";i:1635498054;s:64:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footer.html";i:1635492068;s:66:"/www/wwwroot/www.shuyingjp.com/themes/default/public/footerjs.html";i:1635491960;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<?php endif; 
$info=Db::query("select * from ls_cms_archives as a left join ls_cms_appsyjh as b on a.id = b.id where a.status=1 and a.delete_time = 0 and a.channel_id ='".$category->id."' order by a.id asc limit 0,1");
if(isset($info[0])){
$post=$info[0];
...
$image='';
 ...
 ?>
<div class="section_syjh_soulte clearfix">
    <div class="wrapper">
        <div class="school_tit">全方位解决方案<span>  / 全方位ソリューション</span></div>
        <div class="syjh_soulte_con">
            <div class="syjh_left">
                <?php $sqzd=json_decode($post['sqzd'],true); ?>
                <dl><dt>申请指导</dt>
                    <dd><?php if(is_array($sqzd) || $sqzd instanceof \think\Collection || $sqzd instanceof \think\Paginator): if( count($sqzd)==0 ) : echo "" ;else: foreach($sqzd as $k=>$vo): ?><a style="cursor: default;"><?php echo $vo['title']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></dd></dl>
                <?php $tskc=json_decode($post['tskc'],true); ?>
                <dl><dt>特殊课程</dt>
                    <dd><?php if(is_array($tskc) || $tskc instanceof \think\Collection || $tskc instanceof \think\Paginator): if( count($tskc)==0 ) : echo "" ;else: foreach($tskc as $k=>$vo): ?><a style="cursor: default;"><?php echo $vo['title']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></dd></dl>
                <?php $rykc=json_decode($post['rykc'],true); ?>
                <dl>
                    <dt>日语培训</dt>
                    <dd><?php if(is_array($rykc) || $rykc instanceof \think\Collection || $rykc instanceof \think\Paginator): if( count($rykc)==0 ) : echo "" ;else: foreach($rykc as $k=>$vo): ?><a style="cursor: default;"><?php echo $vo['title']; ?></a><?php endforeach; endif; else: echo "" ;endif; ?></dd>
                </dl>
            </div>
            <img src="/public/images/syjh_img1.jpg" class="syjh_right_img" alt="塾樱计划">
        </div>
    </div>
</div>
<div class="section_syjh_ztc clearfix bgf2f3f5">
    <div class="wrapper">
        <div class="school_tit school_tit_syjhztc">塾樱本科<em>直通车</em><span>  / 学部ワンストップ申請</span></div>
        <?php $ztc_bk=json_decode($post['ztc_bk'],true); ?>
        <ul class="list_syjh clearfix">
            <img src="/public/images/syjh_rank_person.png" class="syjh_rank_person" alt="塾樱本科">
            <img src="/public/images/syjh_rank_zs.png" class="syjh_rank_zs" alt="塾樱本科">
            <?php if(is_array($ztc_bk) || $ztc_bk instanceof \think\Collection || $ztc_bk instanceof \think\Paginator): if( count($ztc_bk)==0 ) : echo "" ;else: foreach($ztc_bk as $k=>$vo): ?>
            <li>
                <strong><?php echo $vo['title']; ?></strong>
                <p><?php echo str_replace('|',"<em></em>",$vo['desc']); ?></p>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
</div>
<div class="section_syjh_ztc clearfix">
    <div class="wrapper">
        <div class="school_tit school_tit_ztc">研究生申请<em>直通车</em> <span>/ 研究生ワンストップ申請</span></div>
        <?php $ztc_yjs=json_decode($post['ztc_yjs'],true); ?>
        <ul class="section_list_system clearfix">
        <?php if(is_array($ztc_yjs) || $ztc_yjs instanceof \think\Collection || $ztc_yjs instanceof \think\Paginator): if( count($ztc_yjs)==0 ) : echo "" ;else: foreach($ztc_yjs as $k=>$vo): ?>
            <li>
                <div class="sys_box">
                    <i></i>
                    <em><?php if($k < 9): ?>0<?php endif; ?><?php echo $k+1; ?></em>
                    <span><?php echo $vo['title']; ?></span>
                </div>
            </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <a class="yjs_consult_btn" rel="nofollow" title="" target="_blank" href="<?php echo (isset($site_info['online_url']) && ($site_info['online_url'] !== '')?$site_info['online_url']:''); ?>" title="点击咨询我们">点击咨询我们 &gt;</a>
    </div>
</div>
<div class="section_syjh_ztc2 clearfix">
    <div class="wrapper">
        <div class="school_tit school_tit_ztc2">大学院直申<em>直通车</em><span> / 大学院ワンストップ申請</span></div>
        <?php $ztc_dxy=json_decode($post['ztc_dxy'],true); ?>
        <ul class="list_syjh_ztc2">
            <?php if(is_array($ztc_dxy) || $ztc_dxy instanceof \think\Collection || $ztc_dxy instanceof \think\Paginator): if( count($ztc_dxy)==0 ) : echo "" ;else: foreach($ztc_dxy as $k=>$vo): ?>
            <li>
                <em>0<?php echo $k+1; ?></em>
                <i></i>
                <strong><?php echo $vo['title']; ?></strong>
...
<div class="section-teacher clearfix bgf2f3f5">
    <div class="wrapper">
...
<div class="section-cases-bk clearfix">
    <div class="wrapper">
		<div class="school_tit school_tit_scases">成功案例<span>/ 成功事例 </span></div>
		<div class="section_list_bkcase clearfix" id="syjh_case_shadow">
		<?php 
   $foot_caselist= Db::name('CmsLxzk')->alias('a')->limit(6)->select()->toArray();
...
<dl>
<a href="<?php echo cmf_url('cms/Abroad/index',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>">
<dt><img src="<?php echo get_img_url($vo['litpic']); ?>" alt="<?php echo $vo['title']; ?>"></dt>
<dd><p><?php echo $vo['title']; ?></p><em><?php echo date('Y-m-d',$vo['create_time']); ?></em><span>申请专业：<?php echo $vo['sqzy']; ?></span><span>申请院校：<?php echo $vo['mbyx']; ?></span>
</dd></a></dl>
<?php endforeach; endif; else: echo "" ;endif; ?>
    	</div>
    </div>
