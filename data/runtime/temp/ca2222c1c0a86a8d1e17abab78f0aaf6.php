...
$image='';
 ...
 ?>
<div class="school_tit school_tit_apply">申请语言学校<span> / 申し込み</span></div>
<div class="apply_con apply_con_language">
...
<div class="wrapper">
<div class="school_tit school_tit_feature">语言学校特点<span>  / 日本語学校の特徴  </span></div>
...
<i></i><img src="/public/images/language_feature_img<?php echo $k+1; ?>.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p>
</div>
<div class="feature_txt_hover">
<i></i><img src="/public/images/language_feature_img<?php echo $k+1; ?>_h.png" alt="<?php echo $vo['desc']; ?>"><strong><?php echo $vo['title']; ?></strong><p><?php echo $vo['desc']; ?></p>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
...
<span><?php echo $vo['title']; ?></span><label><p><?php echo str_replace('|','</p><p>',$vo['desc']); ?>
</p></label>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="wrapper">
<div class="school_tit school_tit_tutor">申请流程<span> / 申請の流れ </span></div>
<?php 
if(!empty($post['applyflow'])){
 ...
 ?>
<ul class="bk_tutor_con bk_language_con">
<?php if(is_array($applyflow) || $applyflow instanceof \think\Collection || $applyflow instanceof \think\Paginator): if( count($applyflow)==0 ) : echo "" ;else: foreach($applyflow as $k=>$vo): ?>
