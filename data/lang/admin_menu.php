...
return array (
  ...
  'CMS_ADMINACTIVEPUSH_INDEX' => '百度API推送',
  'CMS_ADMINARCHIVES_ADD' => '添加文章',
  'CMS_ADMINARCHIVES_ADDPOST' => '添加文章提交',
  'CMS_ADMINARCHIVES_DELETE' => '文章删除',
  'CMS_ADMINARCHIVES_EDIT' => '编辑文章',
  'CMS_ADMINARCHIVES_EDITPOST' => '编辑文章提交',
  'CMS_ADMINARCHIVES_INDEX' => '文章管理',
  'CMS_ADMINARCHIVES_LISTORDER' => '文章排序',
  'CMS_ADMINARCHIVES_PUBLISH' => '文章发布',
  'CMS_ADMINASKS_INDEX' => '问答管理',
  'CMS_ADMINCHANNEL_ADD' => '添加文章分类',
  'CMS_ADMINCHANNEL_ADDPOST' => '添加文章分类提交',
  'CMS_ADMINCHANNEL_DELETE' => '删除文章分类',
  'CMS_ADMINCHANNEL_EDIT' => '编辑文章分类',
  'CMS_ADMINCHANNEL_EDITPOST' => '编辑文章分类提交',
  'CMS_ADMINCHANNEL_INDEX' => '栏目管理',
  'CMS_ADMINCHANNEL_LISTORDER' => '文章分类排序',
  'CMS_ADMINCHANNEL_SELECT' => '文章分类选择对话框',
  'CMS_ADMINCHANNEL_TOGGLE' => '文章分类显示隐藏',
  'CMS_ADMINFEEDBACK_INDEX' => ' 反馈管理',
  'CMS_ADMINFORM_INDEX' => '留言管理',
  'CMS_ADMININDEX_DEFAULT' => '内容管理',
  'CMS_ADMINLXZK_INDEX' => '成功案例',
  'CMS_ADMINMAJOR_INDEX' => '专业列表',
  'CMS_ADMINMODELX_EDITPOST' => '编辑模型提交',
  'CMS_ADMINMODELX_INDEX' => '模型管理',
  'CMS_ADMINPAGE_ADD' => '添加页面',
  'CMS_ADMINPAGE_ADDPOST' => '添加页面提交',
  'CMS_ADMINPAGE_DELETE' => '删除页面',
  'CMS_ADMINPAGE_EDIT' => '编辑页面',
  'CMS_ADMINPAGE_EDITPOST' => '编辑页面提交',
  'CMS_ADMINSPECIAL_INDEX' => '专题管理',
  'CMS_ADMINTAGS_DELETE' => '删除文章标签',
  'CMS_ADMINTAGS_INDEX' => '标签管理',
